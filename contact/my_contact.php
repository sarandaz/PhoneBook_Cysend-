        ...
        <form id="contact">
            <div class="row">
                <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" <?= $user['published'] == true ?  'checked' : ''; ?> name="publish_contact" value="yes" id="publish_contact">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="first_name" value="<?php echo isset($user['first_name']) ? $user['first_name'] : ''  ?>" class="form-control" id="inputFirstName">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="zip_city" value="<?php echo isset($user['zip_city']) ? $user['zip_city'] : ''  ?>" class="form-control" id="inputZipCity">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div id="phone">
                        ...
                        ?>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-check-input" checked="<?= ($user_phones['published'] == true) ?  'checked' : ''; ?>" type="checkbox" id="phone_published" name="phone[0][]" value="yes">
                                </div>
                            </div>
                        <?php  }; ?>
                    </div>
                    ...
                    <div id="email">
                        ...
                        ?>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <input class="form-check-input" type="checkbox" checked="<?= ($user_emails['published'] == true) ?  'checked' : ''; ?>" id="email_published" name="email[0][]" value="yes">
                                </div>
                            </div>
                        <?php } ?>
                    </div>
